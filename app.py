...
if section == "المؤشرات" and not tickers_input:
    ...
    <div style="text-align: center; padding: 50px 20px;">
        <h1 style="color: #58a6ff; margin-bottom: 10px;">👋 مرحبًا بك في StockPro</h1>
        <p style="font-size: 18px; color: #8b949e;">منصتك الاحترافية لتحليل الأسواق المالية بالذكاء الاصطناعي</p>
        
        <div style="display: flex; flex-wrap: wrap; justify-content: center; gap: 20px; margin-top: 40px;">
            <div style="background: #0d1117; padding: 25px; border-radius: 12px; border: 1px solid #30363D; width: 220px; box-shadow: 0 4px 6px rgba(0,0,0,0.3);">
                <div style="font-size: 40px; margin-bottom: 15px;">📈</div>
                <h3 style="color: #e6edf3; font-size: 18px; margin: 0 0 10px 0;">تحليل فني متقدم</h3>
                <p style="font-size: 13px; color: #8b949e; line-height: 1.6;">رسوم بيانية تفاعلية مع مؤشرات RSI, MACD, Bollinger Bands والمزيد.</p>
            </div>
            
            <div style="background: #0d1117; padding: 25px; border-radius: 12px; border: 1px solid #30363D; width: 220px; box-shadow: 0 4px 6px rgba(0,0,0,0.3);">
                <div style="font-size: 40px; margin-bottom: 15px;">🔍</div>
                <h3 style="color: #e6edf3; font-size: 18px; margin: 0 0 10px 0;">ماسح ضوئي ذكي</h3>
                <p style="font-size: 13px; color: #8b949e; line-height: 1.6;">اكتشف الفرص الاستثمارية لحظياً بناءً على الحجم، السعر، والتغيير.</p>
            </div>
            
            <div style="background: #0d1117; padding: 25px; border-radius: 12px; border: 1px solid #30363D; width: 220px; box-shadow: 0 4px 6px rgba(0,0,0,0.3);">
                <div style="font-size: 40px; margin-bottom: 15px;">🛡️</div>
                <h3 style="color: #e6edf3; font-size: 18px; margin: 0 0 10px 0;">إدارة مخاطر</h3>
                <p style="font-size: 13px; color: #8b949e; line-height: 1.6;">حاسبة مخاطر مدمجة ومحفظة افتراضية لتتبع صفقاتك بأمان.</p>
            </div>
        </div>
        
        <div style="margin-top: 50px; padding: 20px; background: #161b22; border-radius: 8px; display: inline-block;">
            <p style="color: #8b949e; margin-bottom: 10px;">💡 ابدأ بكتابة رمز السهم في الأعلى (مثلاً: AAPL, TSLA) أو استخدم الماسح الضوئي.</p>
        </div>
    </div>
    """, unsafe_allow_html=True)
